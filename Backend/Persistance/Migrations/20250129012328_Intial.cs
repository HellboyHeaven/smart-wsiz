    ...
    public partial class Intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:grade_type", "graded,non_gradeds")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeType = table.Column<GradeType>(type: "grade_type", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Direction = table.Column<BusDirection>(type: "bus_direction", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusTimetables_BusStations_StationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Term = table.Column<GradeTerm>(type: "grade_term", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupModule", x => new { x.GroupsId, x.ModuleId });
                    table.ForeignKey(
                        name: "FK_GroupModule_Groups_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupModule_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusStations_Name",
                table: "BusStations",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BusTimetables_StationId",
                table: "BusTimetables",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_Courses_Name_Code",
                table: "Courses",
                columns: new[] { "Name", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Grades_ModuleId",
                table: "Grades",
                column: "ModuleId");
